...
const isGitInstalled = async () => { // This function returns a Promise...

    try { //...which tries to execute the command to check if Git is installed...

        await execCommand('git --version') //...by executing the command to check if Git is installed...

        return true //...and returns true if Git is installed...

    } catch (error) { //...if an error occurs...

        return false //...returns false if Git is not installed
    }
}
...
const main = async () => { // This function returns a Promise...
    ...
    try { //...which first tries to execute the main logic...
        ...
        const gitInstalled = await isGitInstalled() //...by awaiting the isGitInstalled function...

        if (!gitInstalled) { //...and if Git is not installed...

            console.error('Git is not installed. Please install Git and try again.') //...logs that Git is not installed and that the user should install Git and try again...

            return //...then returns from the function...
        }

        const answer = await promptUser() //...otherwise awaiting the promptUser function...
